...
const Cta = () => {
  return (
   <section className="bg-gray-100 lg:py-12 lg:flex lg:justify-center relative">
  <div className="overflow-hidden bg-gradient-to-r from-[#715DD2] to-[#32247B] md:mx-8 mx-2 flex flex-col md:flex-row max-w-6xl lg:w-full px-4 md:py-[60px] py-8 mb-2 lg:shadow-md rounded-xl">
    <div className="w-1/4 hidden md:block">
     <img src='/cta.png' className=' absolute top-2 w-56'/>
    </div>
    <div className="md:w-1/3 md:px-6 flex flex-col text-center md:text-left md:block justify-center">
      <h2 className="text-2xl font-semibold text-white md:text-3xl">
      What are you waiting for?
      </h2>
      <p className="mt-4 text-gray-300">
      Dowanloasfasd fdf sdfsd fasdf a sdfasd asdf 
      a sdf asdfsdfsdfsdf
      </p>
      
    </div>
    <div className="md:w-1/4 flex md:flex-col md:py-0 py-4 justify-center gap-2">
  ...
  <div onClick={()=>setOpen(true)} className="w-full cursor-pointer sm:w-auto flex bg-black hover:bg-gray-700 focus:ring-4 text-white rounded-lg items-center justify-center px-4 py-2.5 focus:ring-gray-700">
    ...
    <div className=" md:px-6 flex md:block justify-center ">
     <img src='/qr.png' className=''/>
    </div>
  </div>
</section>
