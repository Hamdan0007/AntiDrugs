  ...
  <div className="container mx-auto flex px-5 py-40 items-center justify-center flex-col">
    ...
    <div className="text-center lg:w-2/3 w-full">
      ...
      <div className="flex justify-center">
        <button className="inline-flex text-white bg-[#045a0f] border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Donate Us</button>
...
<section className="text-gray-600 body-font">
  <div className="container mx-auto flex px-5 py-32 md:flex-row flex-col items-center">
    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      ...
      <div className="flex justify-center">
        <button className="inline-flex text-white bg-[#045a0f] border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Button</button>
