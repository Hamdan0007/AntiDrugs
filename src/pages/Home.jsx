  ...
  <div className="container mx-auto flex px-5 py-40 items-center justify-center flex-col">
    ...
    <div className="text-center lg:w-2/3 w-full">
      ...
      <div className="flex justify-center">
        <Link to="/donate" className="inline-flex text-white bg-[#353980] border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Donate Us</Link>
        <Link to="/about" className="ml-4 inline-flex text-gray-700 bg-gray-100 border-0 py-2 px-6 focus:outline-none hover:bg-gray-200 rounded text-lg">About Us</Link>
      </div>
    </div>
  </div>
  </div>
